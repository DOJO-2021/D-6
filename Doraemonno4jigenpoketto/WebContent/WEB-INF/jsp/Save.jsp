...
{title:0,
    ...
    function template(dataArray) {
      return dataArray.map(function(data) {
        return         '<form method="GET" action="/Doraemonno4jigenpoketto/SaveServlet"><div class="searchresult"><input type="image" src="/Doraemonno4jigenpoketto/image/検索結果の枠.png" class="r_qb"><input type="text" name="QUESTION" value="' + data.title + '" class="r_question" readonly>'

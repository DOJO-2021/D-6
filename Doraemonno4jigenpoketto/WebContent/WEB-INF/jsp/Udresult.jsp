  ...
  <script>
    ...
    function template(dataArray) {
      return dataArray.map(function(data) {
        return         '<form method="POST" action="/Doraemonno4jigenpoketto/UdresultServlet"><div class="searchresult"><input type="image" src="/Doraemonno4jigenpoketto/image/検索結果の枠.png" class="r_qb"><div class="searchresult"><p class="r_question" style="color:black;">' + data.title .substring(0,32)+ '<br>'+data.title .substring(32,64)+ '<br>'+data.title .substring(64,94)+'</p>'

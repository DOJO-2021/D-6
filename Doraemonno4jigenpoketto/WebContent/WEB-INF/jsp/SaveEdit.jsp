...
<h2><img src="/Doraemonno4jigenpoketto/image/保存編集画面.png" alt="保存編集画面" class="h2"></h2>
		...
		<div >
				 <a href="/Doraemonno4jigenpoketto/SaveServlet"><input type="image" src="/Doraemonno4jigenpoketto/image/戻るボタン.png" class="buttonsize" style="margin-top:-50px; margin-left:30px; margin-bottom:0px;"></a>
		</div>

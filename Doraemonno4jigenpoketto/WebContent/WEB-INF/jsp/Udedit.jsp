...
<div class="titlebar">
<h1><img src="../../image/Udedit/帯.png" class="titlebar"></h1>
        </div>


          <img src="../../image/Udedit/ロゴ.png" alt="DOJO Q&A集" class="logo">


         <div class="logoutbutton">
           <a href="../../src/servlet/MenuServlet.java"><img src="../../image/Udedit/ログアウトボタン.png" alt="ログアウト" class="logoutbutton"></a>
         </div>

<h2><img src="../../image/Udedit/更新・削除画面.png" alt="更新・削除画面" class="h2"></h2>
...
<c:forEach var="e" items="${result}">
	...
	登録者<input type="text" name="registrant" value="${e.registrant}" style="width:23em;">
			...
			<div class=koushinbutton>
				 <input type="image" src="../../image/Udedit/更新ボタン.png" alt="更新" width="140" height="45" name="login">
			</div>
			<div class=sakujyobutton>
				 <input type="image" src="../../image/Udedit/削除ボタン.png" alt="削除" width="140" height="45" name="login">
			</div>
    </form>
</c:forEach>

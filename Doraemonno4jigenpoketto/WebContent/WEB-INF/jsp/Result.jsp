...
<img src="">
<img src="../../image/Result/帯.png" class="titlebar">
<h1><a href="../../src/servlet/Doraemonno4jigenpoketto/MenuServlet"><img src="../../image/Result/ロゴ.png" alt="DOJO Q&A集" class="logo"></a></h1>
...
<h2><img src="../../image/Result/検索結果画面.png" alt="検索結果画面" class="h2"></h2>
	...
	<c:forEach var="e" items="${quastion}">
		<form method="POST" action="DetailServlet.java">
			...
			<div class="searchresult">
				<input type="image" src="../../image/Result/検索結果の枠.png" class="r_qb"><!--r_qb=ResultQuestionBox-->
